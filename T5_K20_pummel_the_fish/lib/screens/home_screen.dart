...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    // T5K20: State Management mit Bloc und Cubit, Variante 1
    /* return BlocProvider(
      create: (context) => ManagePetsCubit(
        context.read<FirestorePetRepository>(),
      )..getAllPets(), */
    // T5K20: State Management mit Bloc und Cubit, Variante 2
    return BlocProvider(
          ...
          return Scaffold(
            ...
            body: SafeArea(
              child: Padding(
                ...
                // T5K20: State Management mit Bloc und Cubit Variante 1
                /* BlocConsumer<ManagePetsCubit, ManagePetsState>(
                  listener: (context, state) {
                    if (state is ManagePetsError) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Es ist ein Fehler aufgetreten."),
                        ),
